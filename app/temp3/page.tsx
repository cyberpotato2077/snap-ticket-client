...
export default function Area3SeatMap() {
      ...
      <div className="flex gap-4">
        ...
        <div className="w-[300px] space-y-4">
          ...
          <div className="flex gap-2">
            <Button variant="outline" className="flex-1">이전 단계</Button>
            <Button variant="outline" className="flex-1" onClick={() => setSelectedSeats([])}>좌석 다시 선택</Button>
          </div>
          <Button className="w-full" disabled={selectedSeats.length === 0}>다음 단계</Button>
        </div>
      </div>
    </main>
  );
